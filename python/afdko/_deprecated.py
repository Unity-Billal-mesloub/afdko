...
def makeotfexe_wrapper() -> NoReturn:
    ...
    message = (
        ...
        "build a CFF table first using 'tx', which has been enhanced with "
        "some features that were previously exclusive to makeotfexe, "
        "including support for GlyphOrderAndAliasDB files.\n\n"
        "Examples:\n"
        "  Old: makeotfexe -f features.fea font.pfa\n"
        "  New: afdko tx -cff +b font.pfa temp.cff && "
        "afdko addfeatures -f features.fea temp.cff\n\n"
        "  Or use the wrapper: afdko makeotf -f font.pfa "
        "-ff features.fea\n\n"
